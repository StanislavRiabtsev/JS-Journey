...
function calc() {
    ...
    function getStaticInformation(selector, actionClass) {
        const elements = document.querySelectorAll(selector);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function tabs(tabsSelector, tabsContentSelector, tabsSelectorParent, activeClass) {
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2025-08-06');
